        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    #s += f"{names[int(c)]}{'s' * (n > 1)}, "
                    val += f'The detected company is {names[int(c)]}\n'
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='data/uploads', help='file/dir/URL/glob, 0 for webcam')
